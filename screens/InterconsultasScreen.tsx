                    ...
                    <div className="flex items-center justify-between py-3 gap-3">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 bg-white text-slate-600 px-3 md:px-4 py-2 rounded-xl font-bold text-[11px] md:text-sm hover:bg-slate-50 border border-slate-200 transition shadow-sm hover:shadow-md mr-1 md:mr-2"
                                title="Ver Estadísticas"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="size-4 md:size-4.5 text-indigo-500 shrink-0">
