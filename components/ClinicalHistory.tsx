    ...
    const fetchData = async () => {
        ...
        if (data) {
            ...
            setPatientData((prev: any) => ({
                ...
                ucin_transfer_date: data.ucin_transfer_date ? new Date(data.ucin_transfer_date).toLocaleString('sv-SE').replace(' ', 'T').substring(0, 16) : '',
                icu_admission: data.icu_admission ? new Date(data.icu_admission).toLocaleString('sv-SE').replace(' ', 'T').substring(0, 16) : '',
                ...
                marital_status: data.marital_status || data.physical_exam?.clinical_extras?.marital_status || '',
                religion: data.religion || data.physical_exam?.clinical_extras?.religion || '',
                occupation: data.occupation || data.physical_exam?.clinical_extras?.occupation || '',
    ...
    const handleSave = async () => {
        ...
        if (patientId === 'new') {
            ...
            const newPatient = {
                ...
                relative: patientData.relative,
                relative_phone: patientData.relative_phone,
                ucin_transfer_date: patientData.ucin_transfer_date || null,
                icu_admission: patientData.icu_admission || null,
                marital_status: patientData.marital_status,
                religion: patientData.religion,
                occupation: patientData.occupation,
